...
@Component({
  selector: 'app-blog-student',
  templateUrl: './blog-student.component.html',
  styleUrls: ['./blog-student.component.css']
})
export class BlogStudentComponent {
  aviso: any;
...
back(){
  localStorage.setItem("detalleid","")
  this.router.navigate(['avisos-student']);
